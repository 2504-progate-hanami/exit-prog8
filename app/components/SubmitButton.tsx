...
export function SubmitButton({
  ...
  return (
    <div className="relative group inline-block">
      <button
        type="button"
        className="bg-teal-500 px-12 py-2 hover:bg-teal-600 text-white rounded" // ボタンに角丸を追加すると見栄えが良いかもしれません
        onClick={onClick}
      >
      ...
      <div
        className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-auto
                   opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" // ホバー時に表示、トランジション追加、マウスイベント無効化
      >
